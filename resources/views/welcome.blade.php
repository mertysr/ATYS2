...
<div class="container">
            ...
            <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
                <div class="container">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <img style="width:30px;height:auto;" src="/guvenmelisin_settings/images/icons/site-icon.png" alt="">
                        ATYS
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                @auth
                                    <a class="nav-link" href="{{ url('/home') }}">Sisteme Dön</a>
                                @else
                        ...
                        <div class="title m-b-md">
                            <center>
                                <div style="font-size:40px; color:gray;">
                                    Ambulans Takip ve Yönetim Sistemi
                                </div>
                            </center>
                        </div>
                    </div>
    ...
    <div class="satir navbar-laravel navbar-light navbar-expand-md">
        <div class="row" style="min-height: 100px;">

            <div class="col-md-12">Sayın Üyemiz,

                TATD ve TDB ortak çalışması olan Diş Hekimleri İçin Tıbbi Acil Durum Yönetimi isimli kitap çıktı.

                Dişhekimlerinin sık karşılaştığı acil tıbbi sorunların ele alındığı ve görsellerle zenginleştirilmiş kitabın önemli bir başvuru kaynağı olacağına inanıyoruz. Tüm meslektaşlarımız için faydalı olmasını dileriz.

                Kitabı PDF formatında <a href="https://www.tatd.org.tr/files/files/dis_hekimleri_icin_tibbi_acil_durum_yonetimi.pdf">buradan</a> indirebilir, basılmış kitap talepleriniz için TDB’ye başvurabilirsiniz.
                <br>
                Saygılarımızla
                <a></a>
                <br>
                Türkiye Acil Tıp Derneği<br><br><br></div>

        </div>
    </div><br>
    <div class="satir navbar-laravel navbar-light navbar-expand-md">
        <div class="row" style="min-height: 100px;">
            <div class="col-md-12">Buraya duyuru eklenecek.</div>
