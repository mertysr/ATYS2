...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6">
            <center>
                <form class="form-inline" method="POST" action="/home/duzenleme/hastaneler/ekle">
                    @csrf
                    <div class="form-group" style="margin-right:20px;">
                        <span>Hastane İsmi</span>
                        <input type="text" name="isim" class="form-control">
                    </div>
                    <div class="form-group" style="margin-right:20px;">
                        <span>Hastanenin Enlem ve Boylamı</span>
        ...
        <div class="col-md-6">
            <div class="widget">
                <div class="widget-header transparent">
                    <h2><strong>Hastaneler</strong> </h2>
                        ...
                        <table class="table" >
                            ...
                            <tbody>
                                @foreach($hastaneler as $key_hastane => $hastane)
                                    <tr>
                                        <td><center>{{$hastane->adi}}</center></td>
                                        <td><center>{{$hastane->lat_long}}</center></td>
                                        <td>
                                            <center>
                                                <div class="btn-group btn-group-xs">
                                                    <a href="/home/duzenleme/hastaneler/sil/{{$hastane->id}}" data-toggle="tooltip" title="Sil" class="btn btn-default"><i class="fa fa-eraser"></i></a>
                                                </div>
                                            </center>
                                        </td>
                                    </tr>
