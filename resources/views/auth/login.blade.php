...
@section('content')
    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
        ...
        <div class="row">
            <div class="iconmelon">
                <img style="width:150px;height:auto;" src="/guvenmelisin_settings/images/icons/site-icon.png" alt="">
            </div>
        </div>

        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center">Ambulans Takip ve Yönetim Sistemi</div>
            </div>
            ...
            <div class="panel-body" >
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group row">
                        <label for="username" class="col-sm-4 col-form-label text-md-right">{{ __('Kullanıcı Adı') }}</label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6 offset-md-4">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> {{ __('Hatırla Beni') }}
                                </label>
